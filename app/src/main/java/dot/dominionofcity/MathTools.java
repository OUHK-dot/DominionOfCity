...
public class MathTools {
    ...
    public static float getCameraAzimuth(float azimuth, float pitch, float roll) {
        /*
    ...
    public static float getInclination(float pitch, float roll) {
        /*
    ...
    public static double positiveMod(double dividend, double divisor) {
    ...
    public static float average(List<Float> numbers, float sum, int length) {
        if (numbers.size() == 0)
            return sum/length;
